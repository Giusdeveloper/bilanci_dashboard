...
export default function CEDettaglioMensilePuntuale2024() {
  ...
  if (!allMonthsData) {
    return (
      <div className="p-6">
        <PageHeader 
          title="CE Dettaglio Mensile - Puntuale 2024" 
  ...
  const createRowData = (label: string, field: string, className: string = "") => {
    ...
    const values = months.map(month => {
      ...
      const monthData = allMonthsData[monthKey]?.puntuale2024;
  ...
  return (
    <div data-testid="page-ce-dettaglio-mensile-puntuale-2024" className="p-6">
      <PageHeader 
        title="CE Dettaglio Mensile - Puntuale 2024" 
        subtitle="Conto Economico Dettagliato - Analisi mensile puntuale 2024"
      />
